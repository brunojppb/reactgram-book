...
If you still have your console running our development command `yarn start`, go to your browser and open `localhost:3000` to see the result. You should see something like this:
